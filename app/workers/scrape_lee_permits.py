...
def login(driver) -> bool:
    """Log in to Sarasota Accela portal."""
    ...
    try:
        driver.find_element(By.ID, "ctl00_PlaceHolderMain_LoginBox_txtUserName").send_keys(SARASOTA_USER)
        driver.find_element(By.ID, "ctl00_PlaceHolderMain_LoginBox_txtPassword").send_keys(SARASOTA_PASS)
        ...
        try:
            driver.find_element(By.CSS_SELECTOR, "input[name*='User'], input[id*='User'], input[type='email']").send_keys(SARASOTA_USER)
            driver.find_element(By.CSS_SELECTOR, "input[name*='Pass'], input[id*='Pass'], input[type='password']").send_keys(SARASOTA_PASS)
            driver.find_element(By.CSS_SELECTOR, "input[type='submit'], button[type='submit']").click()
            time.sleep(3)
            print(f"  Logged in via fallback — at: {driver.current_url}")
            return True
